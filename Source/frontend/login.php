    ...
    <div class="img-bg-log">
        ...
        <div class="container mt-5">
            <div class="col-md-6 offset-md-3 bg-white rounded p-5 mt-5">
                <form action="../backend/login.php" method="POST" id="identicalForm" class="form-horizontal" data-bv-feedbackicons-valid="glyphicon glyphicon-ok"
